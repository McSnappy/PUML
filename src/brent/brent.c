...
/*
  ...
  Parameters:
    ...
    Input, double F ( double x, void *user ), a user-supplied
    function whose local minimum is being sought. Optional pointer
    to user data will be passed to the function.

    Input, void *user, an optional user-supplied pointer
